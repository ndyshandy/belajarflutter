...
class ColorfulButton extends StatefulWidget {
  const ColorfulButton(
      {Key key, this.mainColor, this.secondColor, this.ikonData})
      : super(key: key);
  ...
  State<ColorfulButton> createState() =>
      _ColorfulButtonState(mainColor, secondColor, ikonData);
}
...
class _ColorfulButtonState extends State<ColorfulButton> {
  ...
  _ColorfulButtonState(this.mainColor, this.secondColor, this.ikonData);
